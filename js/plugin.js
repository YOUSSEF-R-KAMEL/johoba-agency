...
$(function () {
  $(window).scroll(function () {
    ...
    if ($(window).scrollTop() > $(".skills").offset().top - 70) {
      $(".skills-progress span.html").css(
        "width",
        $(".skills-progress span.html").data("progress")
      );
      $(".skills-progress span.css").css(
        "width",
        $(".skills-progress span.css").data("progress")
      );
      $(".skills-progress span.javascript").css(
        "width",
        $(".skills-progress span.javascript").data("progress")
      );
      $(".skills-progress span.php").css(
        "width",
        $(".skills-progress span.php").data("progress")
      );
      $(".skills-progress span.mysql").css(
        "width",
        $(".skills-progress span.mysql").data("progress")
      );
    }
  });
});
